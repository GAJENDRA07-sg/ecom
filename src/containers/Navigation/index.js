      ...
      <header className="header fixed-mobile-header">
        <div className="announcement-container">
          <div className="announcement">
            🌿 Origins Tribe is Now Live! Discover Eco-Friendly Essentials Today
            🌿 | Get a Free Jute Bag on Orders Above ₹1299 | Enjoy Free Shipping
            on All Orders Above ₹599! Shop Now and Embrace Sustainable Living!
          </div>
        </div>
        <Container>
          <Row className='align-items-center top-header'>
